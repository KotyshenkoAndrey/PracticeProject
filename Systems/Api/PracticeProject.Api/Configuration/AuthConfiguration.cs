...
public static class AuthConfiguration
{
    public static IServiceCollection AddAppAuth(this IServiceCollection services, IdentitySettings settings)
    {
        ...
        {
            options.AddPolicy(AppScopes.AccessRead, policy => policy.RequireClaim("scope", AppScopes.AccessRead));
            options.AddPolicy(AppScopes.AccessWrite, policy => policy.RequireClaim("scope", AppScopes.AccessWrite));
        });
