...
public class Api : IDisposable
{
    ...
    public async Task<IEnumerable<CarViewModel>> V1_Car_GetAll() =>
        await _api.V1_Car_GetAll(_accessToken);

    public async Task<CarViewModel> V1_Car_GetById(Guid id) =>
        await _api.V1_Car_GetById(_accessToken, id);

    public async Task<CarViewModel> V1_Car_Create(CreateCarViewModel request) =>
        await _api.V1_Car_Create(_accessToken, request);

    public async Task V1_Car_Delete(Guid id) =>
        await _api.V1_Car_Delete(_accessToken, id);
